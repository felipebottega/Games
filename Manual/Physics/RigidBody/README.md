...
- **body_shape_entered:** Emitido quando uma parte do corpo colide com uma parte de outro corpo ou TileMap. Este sinal é mais detlhado e mais indicado quando o corpo possui diversas shapes de colisão distintas e você precisa monitorá-las individualmente.
- **body_shape_exited:** Emitido quando a colisão de uma parte do corpo termina.
