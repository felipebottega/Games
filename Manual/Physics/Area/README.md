...
O node `Area2D` (`Area3D`) fornece detecção e influência. Ele pode detectar e emitir sinais quando objetos entram ou saem da sua área. O `Area2D` também pode ser usado para sobrescrever propriedades físicas (como gravidade) em uma área definida. 

## Propriedades

- **Monitoring:** Se esta propriedade estiver habilitada, a área é capaz de detectar corpos ou outros `Areas2D` que estiverem entrando ou saindo da área do node.
...
- **get_overlapping_areas:** Análogo ao anterior, mas retorna apenas a lista de outros `Area2D` que estejam interceptando a área no momento em que a função é executada.
...
<p align="center">
  <a href="https://github.com/felipebottega/Games/tree/gh-pages/Manual/Physics/RigidBody">⬅ Anterior</a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://github.com/felipebottega/Games/tree/gh-pages/Manual/Physics/CharacterBody">Próximo ➡</a>
</p>
