...
Antes de falar de RID, é importante entender o que é um *resource* (*recurso*) em Godot. A classe `Resource` é a classe base para dados em Godot, ou seja, objetos que contêm informação (texturas, meshes, scripts, animações, tabelas de dados, etc.), mas que não têm comportamento de cena (não são nodes). Recursos apenas guardam dados. Recursos podem conter outros recurso, podem ser salvos em arquivo *.tres* texto ou *.res* binário e, além disso, também é possível criar recurso customizados (script com `extends Resource`) e editá-los no *Inspector* (muito útil para dados configuráveis, como tabelas, itens, entre outros). Tudo isso será visto em detalhe futuramente.

> PS: Você pode armazenar dados usando arrays, dicionários ou classes, mas um recurso é uma estrutura mais robusta e feita para "conversar bem" com a engine. É uma estrutura de dados cuja identidade, persistência, compartilhamento e dependências são gerenciados automaticamente pela engine, fora do escopo do script.

Um RID, como o nome indica, é um identificador de um recurso. Quase todo node e objeto da Godot possui um RID em tempo de excecução. Os servidores necessitam do RID para poder acessar o objeto com o qual se deseja trabalhar. Este é o principal propósito do RID: passar a referência do objeto para o servidor.
...
<p align="center">
  <img width="900" src="https://github.com/user-attachments/assets/bd640d3c-0617-46f9-8ae5-6cddd5e392df" />
</p>
...
> PS: `CanvasItem` não é um objeto desenhado, é um container de comandos de desenho. Servers não criam coisas visuais, eles descrevem o que o render deve fazer.

<p align="center">
  <a href="https://github.com/felipebottega/Games/tree/gh-pages/Manual/Performance/Common/General%20optimization%20tips">⬅ Anterior</a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://github.com/felipebottega/Games/tree/gh-pages/Manual/Performance/CPU/CPU%20optimization">Próximo ➡</a>
</p>
