...
As duas figuras abaixo são exatamente a mesma, não há nenhum efeito 3D de verdade acontecendo. A figura da esquerda tem um normal map embutido que dá esse efeito quando reage à luz, mas o normal map em si é apenas um sprite 2D.
