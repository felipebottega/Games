...
Um *mapa normal* (*normal map*) no contexto de jogos 2D é uma imagem usada para simular relevo e detalhes de iluminação em um objeto 2D, mas sem precisar modelar esse relevo de verdade. Neste mapeamento o vermelho (R) representa a inclinação da superfície no eixo $x$, o verde (G) representa a inclinação no eixo $y$, e o azul (B) representa o quanto a superfície aponta "pra frente", ou seja, o eixo $z$. Essas cores não são para serem vistas como arte, mas sim para serem interpretadas pela engine.

As duas figuras abaixo são exatamente a mesma, não há nenhum efeito 3D de verdade acontecendo. A figura da esquerda tem um normal map embutido que dá esse efeito 3D quando reage à luz, mas o normal map em si é apenas um sprite 2D.
...
<p align="center">
   <img width="400" src="https://github.com/user-attachments/assets/a6cfcb71-0c80-492b-ac6a-b35be0290fa8" />
</p>

## Normal map na prática

Vamos mostrar um exemplo de projeto contendo apenas uma figura com normal map, mas o projeto de Godot completo contém diversos outros exemplos para você checar depois. Você pode baixar o projeto ou pode interagir com ele diretamente [por aqui](https://felipebottega.github.io/Games/Manual/2D/Rendering/2D%20lights%20and%20shadows%20-%20Normal%20Maps/html/).
...
<p align="center">
   <img src="https://github.com/user-attachments/assets/5911c959-a305-49c0-93ea-677ee18a9212" width="250">
   <img src="https://github.com/user-attachments/assets/b3bed145-6252-4128-9ce8-09054affcf03" width="300">
</p>

A aba *Diffuse* é para a figura do sprite e a aba *NormalMap* é para a figura do normal map do sprite. A figura do normal map é um PNG. Arraste as suas duas figuras para suas respectivas abas.
...
<p align="center">
  ...
  <a href="https://github.com/felipebottega/Games/tree/gh-pages/Manual/2D/Rendering/2D%20Meshes">Próximo ➡</a>
</p>
