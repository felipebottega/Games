...
Vimos sobre mensagens de output do editor [neste tutorial](https://github.com/felipebottega/Games/tree/gh-pages/Manual/Scripting/Core%20features/Debug/Output%20panel), mas além disso, a Godot também oferece funcionalidades de log mais avançadas. Veremos as principais neste tutorial.

## Project Settings

Indo em *Project → Project Settings → General → Application → Run* com as configurações avançadas, você pode ver algumas opções relacionadas a log. Elas afetam algumas coisas que aparecem nas abas de output do editor.

<p align="center">
  <img width="900" src="https://github.com/user-attachments/assets/9b7638f8-85bb-436a-92cd-5dae8c3bdbe4" />
</p>
...
Indo em *Project → Project Settings → General → Debug → Settings* com as configurações avançadas, você pode ver algumas opções diferentes relacionadas às mensagens de log no editor.
