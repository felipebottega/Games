...
<p align="center">
  <img width="190" src="https://github.com/user-attachments/assets/9cfd41f9-92d0-4875-a0e8-41548e14c899" />
</p>
...
Feito isso, repetimos o processo de ir em *Project → Project Settings → Globals* e registrar o node como global. Não é necessário registrar o script associado à label. Este script não é global, mas é chamado por um node global.
