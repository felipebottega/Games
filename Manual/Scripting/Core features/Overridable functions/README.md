...
- **_init:** O `_init` é chamado imediatamente quando a instância do script é criada. Esta inicialização de variáveis serve para criar instâncias com parâmetros, assim como é o `__init__` de Python. Veja mais sobre o assunto [neste tutorial](https://github.com/felipebottega/Games/tree/gh-pages/Manual/Scripting/GDScript/GDScript%20reference#construtor).
