...
Estamos falando funções/métodos do node `Node`, que vem vazios e prontos para serem sobrescritos. Cada um tem uma finalidade própria definida pela engine. Vamos falar dos mais gerais aqui, mas existem vários outros. 
