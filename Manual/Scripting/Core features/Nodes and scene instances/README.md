...
Considere as cenas como templates a partir dos quais você pode criar quantas cópias desejar. Uma cópia é chamada de uma "instância" da cena. Isso ocorre em dois passos:

1. Carregar a cena do disco local.
2. Criar uma instância do recurso `PackedScene` carregado (tpda cena carregada é do tipo `PackedScene`).
